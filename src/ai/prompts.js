...
const calibrador_auto = {
  ...
  instrucao: [
    ...
    '- IGNORE anúncios PATROCINADOS e de LOJA vendendo produto NOVO (marcados "Patrocinado",',
    '  vendedor tipo loja/Terabyte/KaBuM, preço com centavos "R$ 99,99", banner promocional).',
    '  O banco é de preço USADO entre pessoas — produto novo de loja contamina a mediana.',
